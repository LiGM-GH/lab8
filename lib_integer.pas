...
interface
    Procedure changesSort(var arr : array of integer);
    overload;
    ...
    Procedure fastSort(var arr : array of integer; arr_begin, arr_end : integer);
    overload;

implementation
    procedure changesSort(var arr : array of integer);
    overload;
    var index1, index2, buffer : integer;
        AnyChanges : boolean;
    begin
    ...
    Procedure selectionSort(var arr : Array of integer);
    overload;
    var index1, index2, min, min_index, buffer : integer;
    begin
    ...
    Procedure insertionSort(var arr : Array of integer);
    overload;
    var index1, index2, elem_buffer : integer;
    begin
        index1 := 0;
    ...
    Procedure fastSort(var arr : Array of integer; arr_begin, arr_end : integer);
    overload;
    var index1, index2, value, buffer, elem : integer;
    begin
        // writeln('Sorting ', arr_begin, ', ', arr_end);
        if arr_end > length(arr) - 1
        then arr_end := length(arr) - 1;
        if arr_begin < 0
        then arr_begin := 0;
        index1 := arr_begin;
        index2 := arr_end;
